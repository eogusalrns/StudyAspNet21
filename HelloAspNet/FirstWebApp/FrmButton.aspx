...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:LinkButton ID="BtnLink" runat="server" Text="네이버" OnClick="BtnLink_Click"></asp:LinkButton><br />
            <asp:ImageButton ID="BtnImage" runat="server" AlternateText="글쓰기"
                ToolTip="글쓰기" OnClick="BtnImage_Click" ImageUrl="~/Images/btn_post.gif" />
        </div>
    </form>
</body>
</html>
